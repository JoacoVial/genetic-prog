...
treshold_scan = np.arange(0,0.00000006,0.000000001)#[0.000000022, 0.000000044, 0.000000037, 0.000000025, 0.000000023] #[0.000000022, 0.000000044, 0.000000037, 0.000000025, 0.000000023] 
alphas = np.arange(0.1,0.3,0.01)#[0.23, 0.18, 0.27, 0.16, 0.29]#[0.23, 0.18, 0.27, 0.16, 0.29] 
...
for data in training_data:
    ...
    with open('{}/{}.json'.format(path,archivo),'w') as params_file:
        params = {
            'tiempo_ejecucion' : tiempo_ejecucion,
            'archivo' : archivo,
            'error' : min_error,
            'Vdot' : best_Vdot,
            'coeficiente' : best_treshold,
            'alpha' : best_alpha
        }
